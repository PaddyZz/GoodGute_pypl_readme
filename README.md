...
```bash
# translate pdf file and toggle off cache and verbose mode and will not show any progress messages in the console and toggle on Development mode
# to show translation execution time and translation statistic and clean the cache if have
